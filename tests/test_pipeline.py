...
class PipelineTest(unittest.TestCase):
    ...
    def test_markdown_parse_error_mentions_file_path(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn(f"正在解析文件：{markdown_path}", stderr.getvalue())
    ...
    def test_llm_parse_error_mentions_document_location(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("正在抽取文件：/tmp/broken-guideline.md", stderr.getvalue())
    ...
    def test_llm_extractor_can_be_selected_explicitly(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertNotIn("default_value", foundation_rows[0])
            self.assertNotIn("preferred_pattern", foundation_rows[0])
